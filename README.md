...
이 프로젝트는 **요정의 숲**의 Flutter 구현체입니다.
...
| 문서 | 설명 |
|------|------|
| [docs/design/gdd_game_0011.json](docs/design/gdd_game_0011.json) | 게임 디자인 문서 |
...
**HUD 파일**: [game/lib/ui/hud/mg_forest_hud.dart](game/lib/ui/hud/mg_forest_hud.dart)
